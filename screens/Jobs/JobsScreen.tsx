...
import  Bedal from '../../icons/3486.svg';
import  Free from '../../icons/3466.svg';
import  Etc from '../../icons/3490.svg';
import  Fix from '../../icons/3488.svg';
...
export default function JobsScreen() {
    ...
    const post = useSelector(jobSelector);
    ...
    const refresh =(e: any)=>{
        ...
        if(scrollY + 200 > contentHeight-scrollHeight){
            if(post.length === 0 ){
                ...
                dispatch(jobsactions.getLatestJob.request(post[post.length-1].createdAt));
            }         
        }
    }
...
<ScrollView onScroll={refresh} scrollEventThrottle={300}>
    ...
    <Cate
     ...
     <CardLine>
     <GesipanMenu><Gesipan> 새로운 </Gesipan>공고 </GesipanMenu>    
                        ...
                        return (<Fragment key={`${item._id}`}>
                            ...
                            <Card>
                                ...
                                <View  style={{justifyContent:"space-between",flexWrap: 'wrap', flexDirection:'row', alignItems:'center'}}>
                                    ...
                                    <Image style={{height:25, width:25, marginTop:5}}source={getTier?.img} />
